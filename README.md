...
<details>
  <summary><b>✨ Clique aqui para revelar os bastidores!</b></summary>
  <br>
  <p>Bem-vindo ao meu repositório! Eu sou a Heloisa, uma desenvolvedora de São Paulo que ama transformar problemas complexos em soluções escaláveis e resilientes. Quando não estou estudando automação, pipelines ou infraestrutura, muito provavelmente estou mergulhada em inteligência artificial ou manipulando modelos para impressão 3D! 👾</p>
  <ul>
    <li>🎯 <b>Missão Atual:</b> Dominar o universo DevOps e Cloud Computing.</li>
    <li>💡 <b>Interesses:</b> Inteligência Artificial, Bancos de Dados (Oracle) e Assistentes Virtuais.</li>
    <li>⚡ <b>Curiosidade:</b> Minha jornada na tecnologia começou unindo o virtual e o físico através da impressão e modelagem 3D.</li>
  </ul>
</details>
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,html,css,python,java,oracle,mysql,aws,azure,docker,git,github,linux,tensorflow" />
  </a>
</div>
...
## 📫 Me mande um 'Hello World'

<div align="center">
  <a href="https://www.linkedin.com/in/heloisa-pgarcia" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="mailto:heloisa.design.99freelas@gmail.com">
